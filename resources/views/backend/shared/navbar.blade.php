        ...
        <div class="navbar-header">
            ...
            <div class="d-none d-md-block text-center">
                <a class="sidebartoggler waves-effect waves-light d-flex align-items-center side-start" href="javascript:void(0)" data-sidebartype="mini-sidebar">
                    ...
                    <img src="{{asset('/assets/img/pharmacy.png')}}" class="light-logo" alt="pg" style="height: 65px !important;" />
            ...
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link navbar-brand d-none d-md-block" href="/home">
                        ...
                        <b class="logo-icon">
                            <!-- Light Logo icon -->
                            <img src="{{asset('/assets/img/pharmacy.jpg')}}" alt="homepage" class="light-logo" style="width: 55px;height: 55px" />
                        </b>
                    ...
                    <div class="dropdown-menu dropdown-menu-right user-dd animated flipInY">
                        <div class="d-flex no-block align-items-center p-3 mb-2 border-bottom">
                            ...
                            <div class="ml-2">
                                ...
                                <a href="{{route('admin.viewProfile')}}" class="btn btn-sm btn-danger text-white mt-2 btn-rounded">View Profile</a>
                            </div>
                        </div>
